...
// PreCheckFunc checks whether the health check shall be performed based on the given object and cluster context.
// For shoot extensions, the cluster resource is *extensions.Cluster.
// For garden extensions, the cluster resource is *operatorv1alpha1.Garden.
...
// Each health check gets the target/shoot and source/seed clients injected
