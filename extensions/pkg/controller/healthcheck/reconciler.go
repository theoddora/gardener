...
func NewReconciler(mgr manager.Manager, actuator HealthCheckActuator, registeredExtension RegisteredExtension, syncPeriod metav1.Duration, class extensionsv1alpha1.ExtensionClass) reconcile.Reconciler {
	return &reconciler{
		actuator:            actuator,
...
func (r *reconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	if r.extensionClass != extensionsv1alpha1.ExtensionClassGarden {
